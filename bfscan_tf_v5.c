  ...
  for (n=0; n<42; n+=2) {
    ...
    if ( topics2011[n][1] == 2 ) {
      ...
      for (i=0; i<NUM_DOCS; i++) {
        ...
        score1 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][2], prob11, plus);
        score1 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][3], prob12, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][2], prob21, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][3], prob22, plus);
    ...
    if ( topics2011[n][1] == 3 ) {
      ...
      for (i=0; i<NUM_DOCS; i++) {
        ...
        score1 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][2], prob11, plus);
        score1 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][3], prob12, plus);
        score1 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][4], prob13, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][2], prob21, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][3], prob22, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][4], prob23, plus);
    ...
    if ( topics2011[n][1] == 4 ) {
      ...
      for (i=0; i<NUM_DOCS; i++) {
        ...
        score1 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][3], prob12, plus);
        score1 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][4], prob13, plus);
        score1 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][5], prob14, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][2], prob21, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][3], prob22, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][4], prob23, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][5], prob24, plus);
    ...
    if ( topics2011[n][1] == 5 ) {
      ...
      for (i=0; i<NUM_DOCS; i++) {
        ...
        score1 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][4], prob13, plus);
        score1 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][5], prob14, plus);
        score1 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][6], prob15, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][2], prob21, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][3], prob22, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][4], prob23, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][5], prob24, plus);
        score2 += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n+1][6], prob25, plus);
