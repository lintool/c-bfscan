  ...
  for (n=0; n<NUM_TOPICS; n++) {
    ...
    if ( topics2011[n][1] == 1 ) {
      ...
      for (i=0; i<NUM_DOCS; i++) {
        ...
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][2], prob1, plus);
      ...
      for (i=0; i<NUM_DOCS; i++) {
        ...
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][2], prob1, plus);
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][3], prob2, plus);
      ...
      for (i=0; i<NUM_DOCS; i++) {
        ...
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][2], prob1, plus);
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][3], prob2, plus);
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][4], prob3, plus);
      ...
      for (i=0; i<NUM_DOCS; i++) {
        ...
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][3], prob2, plus);
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][4], prob3, plus);
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][5], prob4, plus);
      ...
      for (i=0; i<NUM_DOCS; i++) {
        ...
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][4], prob3, plus);
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][5], prob4, plus);
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][6], prob5, plus);
      ...
      for (i=0; i<NUM_DOCS; i++) {
        ...
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][5], prob4, plus);
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][6], prob5, plus);
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][7], prob6, plus);
      ...
      for (i=0; i<NUM_DOCS; i++) {
        ...
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][6], prob5, plus);
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][7], prob6, plus);
        score += (*array_fun_direct[i])(collection_tf, tf, base, topics2011[n][8], prob7, plus);
    ...
    while (heap_delmin(&h, (void**)&min_key, (void**)&min_val)) {
      printf("MB%02d Q0 %ld %d %f bfscan_tf_v5\n", (n+1), tweetids[*min_val], rank, *min_key);
      rank--;
    }
